...
abstract class Wishlist implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\WishlistTableMap';
    ...
    /**
     * Initializes internal state of Base\Wishlist object.
     */
    ...
    public function setUsername($v)
    {
        ...
        if ($this->username !== $v) {
            $this->username = $v;
            $this->modifiedColumns[WishlistTableMap::COL_USERNAME] = true;
        }
    ...
    public function setDrinkId($v)
    {
        ...
        if ($this->drink_id !== $v) {
            $this->drink_id = $v;
            $this->modifiedColumns[WishlistTableMap::COL_DRINK_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : WishlistTableMap::translateFieldName('Username', TableMap::TYPE_PHPNAME, $indexType)];
            $this->username = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : WishlistTableMap::translateFieldName('DrinkId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = WishlistTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Wishlist'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(WishlistTableMap::COL_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = 'username';
        }
        if ($this->isColumnModified(WishlistTableMap::COL_DRINK_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(WishlistTableMap::COL_USERNAME)) {
            $criteria->add(WishlistTableMap::COL_USERNAME, $this->username);
        }
        if ($this->isColumnModified(WishlistTableMap::COL_DRINK_ID)) {
            $criteria->add(WishlistTableMap::COL_DRINK_ID, $this->drink_id);
        }
    ...
    public function clear()
    {
        ...
        if (null !== $this->aDrink) {
            $this->aDrink->removeWishlist($this);
        }
        $this->id = null;
        $this->username = null;
        $this->drink_id = null;
