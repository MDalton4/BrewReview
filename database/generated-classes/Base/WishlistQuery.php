 ...
 * @method     ChildWishlistQuery orderByUsername($order = Criteria::ASC) Order by the username column
 * @method     ChildWishlistQuery orderByDrinkId($order = Criteria::ASC) Order by the drink_id column
 *
 * @method     ChildWishlistQuery groupById() Group by the id column
 * @method     ChildWishlistQuery groupByUsername() Group by the username column
 * @method     ChildWishlistQuery groupByDrinkId() Group by the drink_id column
 *
 ...
 *
 * @method     ChildWishlistQuery leftJoinDrink($relationAlias = null) Adds a LEFT JOIN clause to the query using the Drink relation
 * @method     ChildWishlistQuery rightJoinDrink($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Drink relation
 * @method     ChildWishlistQuery innerJoinDrink($relationAlias = null) Adds a INNER JOIN clause to the query using the Drink relation
 *
 * @method     ChildWishlistQuery joinWithDrink($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Drink relation
 *
 * @method     ChildWishlistQuery leftJoinWithDrink() Adds a LEFT JOIN clause and with to the query using the Drink relation
 * @method     ChildWishlistQuery rightJoinWithDrink() Adds a RIGHT JOIN clause and with to the query using the Drink relation
 * @method     ChildWishlistQuery innerJoinWithDrink() Adds a INNER JOIN clause and with to the query using the Drink relation
 *
 * @method     \UserQuery|\DrinkQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildWishlist findOneByUsername(string $username) Return the first ChildWishlist filtered by the username column
 * @method     ChildWishlist findOneByDrinkId(int $drink_id) Return the first ChildWishlist filtered by the drink_id column *
 ...
 *
 * @method     ChildWishlist requireOneById(int $id) Return the first ChildWishlist filtered by the id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildWishlist requireOneByUsername(string $username) Return the first ChildWishlist filtered by the username column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildWishlist requireOneByDrinkId(int $drink_id) Return the first ChildWishlist filtered by the drink_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildWishlist[]|ObjectCollection findById(int $id) Return ChildWishlist objects filtered by the id column
 * @method     ChildWishlist[]|ObjectCollection findByUsername(string $username) Return ChildWishlist objects filtered by the username column
 * @method     ChildWishlist[]|ObjectCollection findByDrinkId(int $drink_id) Return ChildWishlist objects filtered by the drink_id column
...
abstract class WishlistQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'socialmedia', $modelName = '\\Wishlist', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, username, drink_id FROM wishlist WHERE id = :p0';
        try {
    ...
    public function filterByUsername($username = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(WishlistTableMap::COL_USERNAME, $username, $comparison);
    }
    ...
    public function filterByDrinkId($drinkId = null, $comparison = null)
    {
        if (is_array($drinkId)) {
            ...
            if (isset($drinkId['min'])) {
                $this->addUsingAlias(WishlistTableMap::COL_DRINK_ID, $drinkId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($drinkId['max'])) {
                $this->addUsingAlias(WishlistTableMap::COL_DRINK_ID, $drinkId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(WishlistTableMap::COL_DRINK_ID, $drinkId, $comparison);
    }
    ...
    public function filterByUser($user, $comparison = null)
    {
        if ($user instanceof \User) {
            return $this
                ->addUsingAlias(WishlistTableMap::COL_USERNAME, $user->getUsername(), $comparison);
            ...
            return $this
                ->addUsingAlias(WishlistTableMap::COL_USERNAME, $user->toKeyValue('PrimaryKey', 'Username'), $comparison);
        } else {
    ...
    public function filterByDrink($drink, $comparison = null)
    {
        if ($drink instanceof \Drink) {
            return $this
                ->addUsingAlias(WishlistTableMap::COL_DRINK_ID, $drink->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(WishlistTableMap::COL_DRINK_ID, $drink->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
