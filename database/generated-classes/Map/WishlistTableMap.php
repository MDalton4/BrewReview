...
class WishlistTableMap extends TableMap
{
     ...
     */
    const COL_USERNAME = 'wishlist.username';

    /**
     * the column name for the drink_id field
     */
    const COL_DRINK_ID = 'wishlist.drink_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Username', 'DrinkId', ),
        self::TYPE_CAMELNAME     => array('id', 'username', 'drinkId', ),
        self::TYPE_COLNAME       => array(WishlistTableMap::COL_ID, WishlistTableMap::COL_USERNAME, WishlistTableMap::COL_DRINK_ID, ),
        self::TYPE_FIELDNAME     => array('id', 'username', 'drink_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Username' => 1, 'DrinkId' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'username' => 1, 'drinkId' => 2, ),
        self::TYPE_COLNAME       => array(WishlistTableMap::COL_ID => 0, WishlistTableMap::COL_USERNAME => 1, WishlistTableMap::COL_DRINK_ID => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'username' => 1, 'drink_id' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(WishlistTableMap::COL_USERNAME);
            $criteria->addSelectColumn(WishlistTableMap::COL_DRINK_ID);
        } else {
